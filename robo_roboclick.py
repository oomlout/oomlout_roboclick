...
def ai_check_for_too_many_requests_open_ai(**kwargs):
    ...
    if True:
        clip = text
        if "you've hit the plus plan limit" in clip.lower() or "you have reached your free image generation limit" in clip.lower() or "you've reached your image creation limit" in clip.lower() or "re out of images".lower() in clip.lower() or "You’re out of image creations for now".lower() in clip.lower():   
