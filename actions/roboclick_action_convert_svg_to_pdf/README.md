# roboclick_action_convert_svg_to_pdf
...
- Name: `roboclick_action_convert_svg_to_pdf`
- Name long: `RoboClick Action: Convert Svg To Pdf`
- Category: `Conversion`
- Description: Self-contained action migrated from `convert_svg_to_pdf` (old/oomlout_ai_roboclick.py:912). Action logic is implemented directly in old().
