...
def describe():
    ...
    d["name_short"] = ['open_url', 'browser_open_url']
    d["name_short_options"] = ['open_url', 'browser_open_url']
...
def action(**kwargs):
    return robo_roboclick.robo_action_run("roboclick_action_browser_open_url", old, **kwargs)
